...
export function NeonOrbs({ className, children }: NeonOrbsProps) {
  ...
  return (
    <div className={cn("relative w-full h-full overflow-hidden flex items-center justify-center transition-colors duration-500 bg-background", className)}>
      {/* Top-left orb */}
      <div
      ...
      <style jsx global>{`
        ...
        .orb-light {
          background: radial-gradient(circle at 50% 50%, #ffffff 0%, #ffffff 90%, transparent 100%);
          box-shadow: 
